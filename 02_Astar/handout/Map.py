...
class Map_Obj():
    ...
    def draw_path(self, path):
        '''Draw the given path on the map using the value -2

        :parameter path: A list of 2d-tuples specifying locations
        '''

        for location in path:
            self.replace_map_values(location, -2, self.goal_pos)
